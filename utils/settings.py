...
adb = "/home/remy/Android/Sdk/platform-tools/adb"
...
applications = [
    ...
    TestedApplication("NewRelic", "monitoring", "scenarios/monitoring/mo_newrelic.sh", 30, "tpl.monitoring.newrelic", "apks/monitoring/newrelic.apk"),
    TestedApplication("nosdk", "monitoring", "scenarios/monitoring/mo_nosdk.sh", 30, "tpl.monitoring.template", "apks/monitoring/nosdk.apk"),
    ...
    TestedApplication("nosdk", "advertising", "scenarios/advertising/ad_nosdk.sh", 40, "tpl.ads.banner.template", "apks/advertising/nosdk.apk"),
    ...
    TestedApplication("NewRelic", "crash_reporting", "scenarios/crash_reporting/cr_newrelic.sh", 20, "tpl.crashreporting.newrelic", "apks/crash_reporting/newrelic.apk"),
    ...
    TestedApplication("nosdk", "crash_reporting", "scenarios/crash_reporting/cr_nosdk.sh", 20, "tpl.crashreporting.template", "apks/crash_reporting/nosdk.apk")
]
